...
const News = (props) => {
  ...
  useEffect(() => {
    document.title = `${capitalfl(props.category)} - Headlines Hub`;
    updateNews();
  }, []);
  ...
  return (
    <div className="container my-3 ">
      <h2 className="text-white text-center " style={{ marginTop: "70px" }}>
        Headlines Hub - Top {capitalfl(props.category)} Headlines
      </h2>
      {loading && <Spinner />}
